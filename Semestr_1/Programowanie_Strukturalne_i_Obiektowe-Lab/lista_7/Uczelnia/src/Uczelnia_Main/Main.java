...
public class Main {
    public static void main(String[] args) {
        ...
        uczelnia.getOsoby().add(new Student("Mariusz2", "Nowacki2", "12345678901", 20, 'M', "280050", 2, false, true, true));
        ...
        uczelnia.getOsoby().add(new PracownikAdministracyjny("Mariusz2", "Pudzianowski2", "34567890123", 40, 'M', 10, 9999, "Referent", 100));
