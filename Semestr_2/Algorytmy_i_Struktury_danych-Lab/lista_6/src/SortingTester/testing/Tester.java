package SortingTester.testing;

import SortingTester.core.AbstractSortingAlgorithm;
import SortingTester.core.AbstractSwappingSortingAlgorithm;
import SortingTester.measuring.Statistics;
import SortingTester.measuring.Timer;
import SortingTester.testing.generation.Generator;
import SortingTester.testing.results.Result;
import SortingTester.testing.results.RunResult;

import java.util.List;

public class Tester {

	public static <T> SortingTester.testing.results.swapping.RunResult runOnce(AbstractSwappingSortingAlgorithm<MarkedValue<T>> algorithm,
	...
	public static <T> SortingTester.testing.results.swapping.Result runNTimes(AbstractSwappingSortingAlgorithm<MarkedValue<T>> algorithm,
		...
		for(int n = 0; n < repetitions; ++n) {
			SortingTester.testing.results.swapping.RunResult result = runOnce(algorithm, generator, size);
		...
		return new SortingTester.testing.results.swapping.Result(time.average(), time.standardDeviation(),
	...
	private static SortingTester.testing.results.swapping.RunResult repack(RunResult result, long swaps) {
		return new SortingTester.testing.results.swapping.RunResult(result.timeInMilliseconds(), result.comparisons(), swaps,
